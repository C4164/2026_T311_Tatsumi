...
namespace Resource
{
	static const std::wstring blankPath = L"Data/Texture/chery.png";
	...
	static const std::wstring cherryPath = L"Data/Texture/chery.png";
	static const std::wstring sevenPath = L"Data/Texture/seven.png";
	static const std::wstring barPath = L"Data/Texture/blank.png";
